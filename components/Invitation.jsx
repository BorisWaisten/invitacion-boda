        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div>
            ...
            <button className={`py-2 px-4 w-1/3 mt-2 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded-lg ${playfairDisplay.className}`}>
              <a href="[Link de Google Calendar]" target="_blank" rel="noopener noreferrer">Agendar</a>
            </button>
            ...
            <button className={`py-2 px-4 w-1/3 mt-2 bg-blue-500 hover:bg-blue-700 text-white font-bold rounded-lg ${playfairDisplay.className}`}>
              <a href="[Link de Confirmación]" target="_blank" rel="noopener noreferrer">Confirmar Asistencia</a>
            </button>
