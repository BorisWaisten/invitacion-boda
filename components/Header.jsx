    ...
    <header className="relative">
      <div className="relative w-full h-[80vh] md:h-[100vh] lg:h-[150vh]">
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
          <p className="text-lg md:text-2xl lg:text-3xl font-bold mb-4 underline">22.03.2025</p>
          ...
          <p className="font-bold text-lg md:text-lg lg:text-xl mt-4 md:mt-20 text-center">
