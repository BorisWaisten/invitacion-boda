...
const Header = () => {
  return (
    <header className="flex justify-center min-h-screenitems-center relative">
      <div className="w-full h-auto relative">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 flex flex-col justify-center items-center text-white">
          ...
          <p className="text-2xl sm:text-3xl md:text-2xl lg:text-5xl font-serif mt-4">¡NOS CASAMOS!</p>
          <p className="text-xs md:text-lg lg:text-xl  mt-4 md:mt-20 text-center ">
